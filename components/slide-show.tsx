...
export function SlideShow({ movies }: CarauselProps) {
  ...
  return (
    ...
    >
      {movies?.map((movie) => {
        return (
          <SwiperSlide className="slide-show-slide mask" key={movie.imdbCode}>
            <Flex
            ...
            >
              ...
              >
                ...
                <Text fontSize="18px">Genres: {movie.genres.join(' / ')}</Text>
